...
using Proiect_1_Sfranciog.Models.ViewModels;
    ...
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> Create(EventViewModel viewModel, IFormCollection form)
        {
            try
            {
                ...
                TempData["Alert"] = "Succes! You created a new event for: " + form["Event.Name"];
        ...
        public async Task<IActionResult> Edit(int id, IFormCollection form)
        {
            ...
            try
            {
                ...
                TempData["Alert"] = "Succes! You modified an event for: " + form["Event.Name"];
